# Kubernetes Demo for Spark Cluster
...
This is a derivative work based on https://github.com/kubernetes/examples.git.

The Docker images are heavily based on https://github.com/mattf/docker-spark.
And are later curated in https://github.com/kubernetes/application-images/tree/master/spark.
But the vesion used here is within the same github project.
